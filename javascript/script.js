...
function test_event(e) {
    if (e.key === "Enter") {
        ...
        location.href = 'search.html?' + 'page=1/';
    }
    return false;
}
...
$(document).ready(function () {
    json.forEach(function (item, index) {
        ...
        $('.' + item.category[0]).on('click', function () {
            if (current.indexOf('category.html?') != -1){ location.href = 'product.html?' + 'category=' + item.category[0] + '&page=1/'; }
            else { location.href = 'category.html?' + 'category=' + item.category[0]+ '/'; }
        });

//ここから現在地がcategory.htmlの場合-------------------------------------------------------------------------------------------------------------------
        if (current.indexOf('category.html?' + 'category=' + item.category[0] + '/') != -1) {
...
//ここまで現在地がcategory.htmlの場合-------------------------------------------------------------------------------------------------------------------
        ...
        if (item.product != null) {
            ...
            if (current.indexOf('product.html?' + 'category=' + item.category[0]) != -1) {

                //ページ数分回すfor文
                let page_limit = Math.ceil(item.product.length / 20);
                for (let page_num = 1; page_num <= page_limit; page_num++) {
//ここから現在地がproduct.htmlの場合-------------------------------------------------------------------------------------------------------------------
                    if (current.indexOf('product.html?' + 'category=' + item.category[0] + '&page=' + page_num + '/') != -1) {
                        ...
                        $(breadcrumb_3html).attr('href', 'product.html?' + 'category=' + item.category[0] + '&page=1/');
                        ...
                        if (item.product.length > 20) {
                            ...
                            for (let i = 0; i < page_limit + 1; i++) {
                                ...
                                add_prev.addEventListener('click', (event) => {
                                    location.href = 'product.html?' + 'category=' + item.category[0] + '&page=' + (page_num - 1) + '/';
                                });
                                //クリックした数字のページまで遷移
                                add_span.addEventListener('click', (event) => {
                                    location.href = 'product.html?' + 'category=' + item.category[0] + '&page=' + (i + 1) + '/';
                                });
                                //「次へ」をクリックすると現在地を+1
                            ...
                            if (7 < page_limit && page_limit - page_num < 4) {
                                ...
                                add_spanmin.addEventListener('click', (event) => {
                                    location.href = 'product.html?' + 'category=' + item.category[0] + '&page=1/';
                                });
                            }
                            ...
                            //現在地5以上 && 最大値が現在地+4以上   (現在地5~)
                                ...
                                add_spanmax.addEventListener('click', (event) => {
                                    location.href = 'product.html?' + 'category=' + item.category[0] + '&page=' + page_limit + '/';
                                });
                            }
                            //現在地1~4
...
//ここから現在地がsearch.htmlの場合--------------------------------------------------------------------------------------------------------------
    ...
    for (let page_num = 1; page_num <= search_limit; page_num++) {
        if (current.indexOf('search.html?' + 'page=' + page_num + '/') != -1) {
            $(search).attr('value', sessionStorage.getItem('search'))
            ...
            if (search_arr.length > 20) {
                ...
                for (let i = 0; i < search_limit + 1; i++) {
                    ...
                    //「前へ」をクリックすると現在地を-1
                    add_prev.addEventListener('click', (event) => {
                        location.href = 'search.html?' + 'page=' + (page_num - 1) + '/';
                    });
                    //クリックした数字のページまで遷移
                    add_span.addEventListener('click', (event) => {
                        location.href = 'search.html?' + 'page=' + (i + 1) + '/';
                    });
                    //「次へ」をクリックすると現在地を+1
                    add_next.addEventListener('click', (event) => {
                        location.href = 'search.html?' + 'page=' + (page_num + 1) + '/';
                ...
                //現在地5以上 && 最大値が現在地+4以上   (現在地5~)
                    ...
                    add_spanmax.addEventListener('click', (event) => {
                        location.href = 'search.html?' + 'page=' + search_limit + '/';
                    });
                }
